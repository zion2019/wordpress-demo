...
(
	...
	function Widget( completion, data ) {
		...
		(
			completion.options.container || document.body
		).appendChild( hints );
		...
		if ( overlapY > 0 ) {
			var height = box.bottom - box.top, curTop = pos.top - (
			                                            pos.bottom - box.top
			);
		...
		cm.on( "scroll", this.onScroll = function () {
			...
			hints.style.left = (
				                   left + startScroll.left - curScroll.left
			                   ) + "px";
		} );
