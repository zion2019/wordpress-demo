 ...
 */
$image = apply_filters( 'startapp_shortcode_amazon_bg', STARTAPP_CORE_URI . '/img/market-btns/amazon.png' );
$text  = startapp_get_text( esc_html( $a['text'] ), '<span>', '</span>' );
