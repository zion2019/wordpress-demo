...
$a = shortcode_atts( apply_filters( 'startapp_shortcode_default_atts', array(
	'name'      => __( 'BlackBerry World', 'startapp' ),
	'text'      => __( 'Available on', 'startapp' ),
	'link'      => '',
	'animation' => '',
	'class'     => '',
), $shortcode ), $atts );
 ...
 */
$image = apply_filters( 'startapp_shortcode_blackberry_bg', STARTAPP_CORE_URI . '/img/market-btns/blackberry.png' );
