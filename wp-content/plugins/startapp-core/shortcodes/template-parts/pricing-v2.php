 ...
 * Pricing Plan
 *
 * Template part for displaying Pricing Plan: Version 2
 *
 * You can override this template-part by copying it to:
 *     theme-child/template-parts/pricing-v2.php
 *     theme/template-parts/pricing-v2.php
 *
...
<div <?php echo startapp_get_attr( $args['attr'] ); ?>>
	<div class="<?php echo esc_attr( $args['class'] ); ?>">
		<div class="inner">
			...
			startapp_the_text( esc_html( $args['description'] ), '<span class="pricing-plan-description padding-bottom-1x">', '</span>' );
			?>
			<hr>
			<?php
