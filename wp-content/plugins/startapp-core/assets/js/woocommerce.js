 ...
 */
var startappWCProductsAttributeDependencyCallback;

startappWCProductsAttributeDependencyCallback = function () {
	(function ( $, shortcode ) {
		var $filter, $empty;
		var valuesNotFound = $( '<div class="vc_checkbox-label"><span>No values found</span></div>' );
