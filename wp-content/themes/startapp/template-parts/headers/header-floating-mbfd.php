<?php
/**
 * The template part for displaying the header "Floating Menu Button Dark Fullscreen"
 *
 * @author 8guild
 */
?>
<header class="<?php startapp_header_class( 'navbar-floating-menu navbar-floating-menu-dark fs-menu' ); ?>">
