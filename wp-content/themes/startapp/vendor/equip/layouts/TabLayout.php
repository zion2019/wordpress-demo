...
class TabLayout extends Layout {
	 ...
	 */
	public function __construct( $id, $title, $settings = array(), Layout $parent = null ) {
		$settings = array_merge( $settings, array( 'id' => $id, 'title' => $title ) );
	 ...
	 * @return Layout
	 */
	public function add_tab( $id, $title, $settings = array() ) {
		return $this->parent;
	}
